...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-022-small-sieve-maximal-sets-4a20c571-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-022"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-022-small-sieve-maximal-sets-4a20c571-v1",
      "problem_contract_sha256": "eb96e8bdbec2d966e96c620f33940c1a4740d24974677993dee0262137eb383a",
      "problem_id": "problem:um-green-022-small-sieve-maximal-sets-4a20c571",
      "route_id": "route:um-green-022-small-sieve-maximal-sets-4a20c571-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-022-small-sieve-maximal-sets-4a20c571-source-fidelity-01",
      "graph_id": "graph:um-green-022-small-sieve-maximal-sets-4a20c571-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-022-small-sieve-maximal-sets-4a20c571-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-022-small-sieve-maximal-sets-4a20c571-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose that a small sieve process leaves a set of maximal size. What is the structure of that set?"
          },
          "statement_sha256": "f55453a553bab5bcfebd40469350f2a4d5fbed42c229a20a16e4dad1f36a0629"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-022-small-sieve-maximal-sets-4a20c571-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-022-small-sieve-maximal-sets-4a20c571-root",
      "route_id": "route:um-green-022-small-sieve-maximal-sets-4a20c571-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-022-163f5c82783c",
        "url": "https://www.unsolvedmath.com/problems/GREEN-022"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
